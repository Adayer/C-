...
//Este fichero contiene las soluciones a los ejercicios 9,10 y 11
//Descomentar solo la region de la practica que se quiere comprobar y comentar el resto
...
#pragma region Practica10
	...
	//if (pFile)
	//{
	//	//Cadena de ejemplo "-5,10,23,-80,75"
